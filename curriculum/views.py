...
def getCurriculumNivel(request, id_chapter_mineduc):
	...
	try:
		...
		return render_to_response('curriculumnivel.html', {'topic_mineduc':tpmin, 'nombrecapitulo':nombrechapter[0]['name'], 'json_data':json_data, 'topictree_json_string':topictree_json_string, 'topictree_json_string_video':topictree_json_string_video}, context_instance=RequestContext(request))
