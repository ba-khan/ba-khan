...
display.start()
class TestVerCursoEditarNotaMaxima(unittest.TestCase):
    def setUp(self):
    ...
    def test_ver_curso_editar_nota_maxima(self):
        ...
        driver.find_element_by_id("nota_maxima").clear()
        driver.find_element_by_id("nota_maxima").send_keys("0")
