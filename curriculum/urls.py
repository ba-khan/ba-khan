...
urlpatterns = [
    ...
    url(r'^curriculumNivel$', views.getCurriculumNivel, name='getCurriculumNivel'),
    url(r'^nivel/(?P<id_chapter_mineduc>[0-9]+)/$', 'curriculum.views.getCurriculumNivel', name='getCurriculumNivel'),
]