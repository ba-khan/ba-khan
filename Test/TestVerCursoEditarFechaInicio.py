...
#display.start()
class TestVerCursoEditarFechaInicio(unittest.TestCase):
    def setUp(self):
    ...
    def test_ver_curso_editar_fecha_inicio(self):
        ...
        driver.find_element_by_id("fecha_inicio").clear()
        driver.find_element_by_id("fecha_inicio").send_keys("2017-01-01")
