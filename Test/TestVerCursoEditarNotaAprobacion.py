...
display.start()
class TestVerCursoEditarNotaAprobacion(unittest.TestCase):
    def setUp(self):
    ...
    def test_ver_curso_editar_nota_aprobacion(self):
        ...
        driver.find_element_by_id("nota_aprobacion").clear()
        driver.find_element_by_id("nota_aprobacion").send_keys("8")
